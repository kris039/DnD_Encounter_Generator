...
class Player(Frame):
    def __init__(self, master, player_id, name, hp, kp, att1, att1_mod, att1_dmg_mod, att2, att2_mod, att2_dmg_mod, wytr, ref, wola):
        ...
        self.name.set(name + ' ' + str(player_id))
        self.hp.set(hp)
        self.kp.set(kp)
        self.att1.set(att1)
        ...
        self.label_name.grid(row=0, column=0, columnspan=3, padx=self.ui_spacing, pady=self.ui_spacing)
